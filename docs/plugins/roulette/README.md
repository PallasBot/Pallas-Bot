...
精确口令与「何人可用」以群内 **牛牛帮助** 为准。醉酒时表现可能更随机，见 [喝酒](../drink/README.md)。
...
控制台对应插件页。见 [`packages/roulette/config.py`](../../../packages/roulette/config.py)。
...
[`packages/roulette/`](../../../packages/roulette/)
