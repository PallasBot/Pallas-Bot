...
完整键表见 [persona-llm-roadmap](../architecture/persona-llm-roadmap.md)、[配置存储](../architecture/settings-storage.md)。
...
见 [Docker 部署](../DockerDeployment.md)。
...
| [Bot ↔ AI 仓](../architecture/pallas-ai-service.md) | API 契约 |
| [接话 LLM 路线图](../architecture/persona-llm-roadmap.md) | persona / fallback |
| [方舟 KB](../architecture/arknights-knowledge-mcp.md) | 干员查询与 tools |
| [插件 Cookbook](../develop/plugin/cookbook.md) | 写扩展插件 |
