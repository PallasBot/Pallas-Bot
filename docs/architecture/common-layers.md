...
| features | `src/features/` | `cmd_perm`、`command_limits`、`message_scrub`、`community_stats`、`corpus`、`control_plane`、`ban_gate`、`persona`（接话行为；LLM 路线图见 [persona-llm-roadmap.md](persona-llm-roadmap.md)） |
