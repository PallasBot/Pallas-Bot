...
async def list_fanout_bot_ids(group_id: int) -> list[int]:
    ...
    from pallas.core.platform.multi_bot.group_fleet_probe import list_group_online_bot_ids
...
async def send_repeater_answers(bot_id: int, group_id: int, answers, *, fanout: bool = False) -> None:
    ...
    from packages.repeater import post_proc
    ...
    async for item in answers:
        ...
        try:
            ...
            from packages.repeater import is_shutup
