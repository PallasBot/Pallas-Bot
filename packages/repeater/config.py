...
class Config(BaseModel, extra="ignore"):
    ...
    learn_concurrency: int = Field(
        ...
        json_schema_extra=_ui("学习与持久化", 40),
    )
    ...
    fanout_enabled: bool = Field(
        ...
        json_schema_extra=_ui("学习与持久化", 60),
    )
