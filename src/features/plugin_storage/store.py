...
from src.features.plugin_storage.schema import storage_decl_for
from src.foundation.config import BotConfig, GroupConfig, UserConfig

if TYPE_CHECKING:
    from src.features.plugin_storage.metadata import PluginStorageDecl
...
async def get_plugin_storage(
    ...
    *,
    ...
    if active_scope == "deploy":
        from src.features.plugin_storage.deploy_store import read_deploy_plugin_blob
