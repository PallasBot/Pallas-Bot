...
_DUEL_SESSION = ("pallas_plugin_duel.duel_session", "src.plugins.duel.duel_session")
_DUEL_QTE = ("pallas_plugin_duel.duel_qte", "src.plugins.duel.duel_qte")
_DUEL_OPS = ("pallas_plugin_duel.arknights_ops", "src.plugins.duel.arknights_ops")
