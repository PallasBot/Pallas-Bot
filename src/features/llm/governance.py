...
from src.foundation.db.pool_budget import cap_by_pg_pool, pg_pool_under_pressure
...
async def is_llm_chat_cooldown_ready(event: MessageEvent, *, default_cd_sec: int | None = None) -> bool:
    from src.features.command_limits import get_command_cooldown_sec, is_command_cooldown_ready
...
async def refresh_llm_chat_cooldown(event: MessageEvent, *, default_cd_sec: int | None = None) -> None:
    from src.features.command_limits import get_command_cooldown_sec, refresh_command_cooldown
