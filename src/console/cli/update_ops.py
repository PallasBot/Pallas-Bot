...
from src.foundation.config.repo_settings import merged_repo_settings_upper
...
def webui_update_settings_from_repo() -> dict[str, str]:
    ...
    return {
        "repo": (env.get("PALLAS_WEBUI_DIST_ZIP_REPO") or "PallasBot/Pallas-Bot-WebUI").strip(),
        "asset": (env.get("PALLAS_WEBUI_DIST_ZIP_ASSET") or "dist.zip").strip(),
