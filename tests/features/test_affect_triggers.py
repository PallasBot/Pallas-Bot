...
from src.features.persona.affect_triggers import (
...
def test_merge_affect_refine_stores_triggers() -> None:
    from src.features.persona.affect_triggers import apply_affect_refine_triggers_to_profile
...
async def test_resolve_persona_for_message_applies_triggers(monkeypatch: pytest.MonkeyPatch) -> None:
    from src.features.persona.loader import invalidate_persona_cache, resolve_persona_for_message
    ...
    monkeypatch.setattr("src.features.persona.loader.resolve_persona", fake_resolve_persona)
    monkeypatch.setattr("src.features.persona.loader.load_affect_triggers", fake_load_triggers)
