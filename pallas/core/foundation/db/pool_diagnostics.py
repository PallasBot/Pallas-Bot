...
def learn_runtime_snapshot() -> dict[str, Any]:
    try:
        from packages.repeater.learn_queue import drain_learn_pause_stats, learn_concurrency, learn_queue
...
async def emit_pool_diagnostics_tick() -> None:
    ...
    from pallas.product.corpus.remote_budget import drain_remote_corpus_skip_counters
