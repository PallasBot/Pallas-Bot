...
class LlmConfig(BaseModel):
    ...
    llm_semantic_style_realtime_daily_limit: int = Field(default=2000, ge=0, le=20000)
    ...
    llm_feedback_retention_scheduled_enabled: bool = Field(default=True)
    llm_feedback_retention_days: int = Field(default=7, ge=1, le=90)
    ...
    llm_memory_hit_boost_enabled: bool = Field(default=True)
...
def get_llm_config() -> LlmConfig:
    ...
    with _config_lock:
        ...
        _cached_llm_config = LlmConfig(
            ...
            llm_session_user_storage_window=_env_int("LLM_SESSION_USER_STORAGE_WINDOW", 200),
            ...
            llm_semantic_style_realtime_daily_limit=_env_int("LLM_SEMANTIC_STYLE_REALTIME_DAILY_LIMIT", 2000),
            ...
            llm_feedback_retention_scheduled_enabled=_env_bool("LLM_FEEDBACK_RETENTION_SCHEDULED", True),
            llm_feedback_retention_days=_env_int("LLM_FEEDBACK_RETENTION_DAYS", 7),
            ...
            llm_memory_hit_boost_enabled=_env_bool("LLM_MEMORY_HIT_BOOST_ENABLED", True),
            llm_memory_hit_boost_sec=_env_int("LLM_MEMORY_HIT_BOOST_SEC", 3600),
