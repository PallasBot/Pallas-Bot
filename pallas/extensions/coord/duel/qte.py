...
def publish_single_qte_request(
    *,
    ...
    from pallas.extensions.coord.duel.qte_redis import read_session_redis_sync, store_session_redis_sync
...
async def _run_local_single_job(data: dict[str, Any]) -> None:
    ...
    from pallas.extensions.coord.duel.qte_redis import (
...
async def wake_duel_qte_session(session_id: str, local_ids: frozenset[str]) -> None:
    ...
    from pallas.extensions.coord.duel.qte_redis import read_session_redis_sync
...
async def try_claim_race_coord_winner(session_id: str, winner_uid: str) -> bool:
    from pallas.extensions.coord.duel.qte_redis import try_write_race_winner_redis_sync
