...
def drift_payload_to_dict(payload) -> dict[str, Any]:
    from pallas.core.plugin_coord.dream import drift_payload_to_dict as to_dict

    return to_dict(payload)


def drift_payload_from_dict(data: dict[str, Any]):
    from pallas.core.plugin_coord.dream import drift_payload_from_dict as from_dict
...
async def ingest_dream_drift_event(data: dict[str, Any]) -> None:
    ...
    try:
        ...
        return
    from pallas.core.plugin_coord.dream import deliver_drift_payload
