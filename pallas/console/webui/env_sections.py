...
_INGRESS_DISPATCH_SKIP = frozenset({
    ...
    "conversation_scheduler_adaptive_max",
    "conversation_scheduler_adaptive_interval_sec",
...
def _ingress_dispatch_section() -> WebuiEnvSection:
    ...
    return WebuiEnvSection(
        ...
        field_to_env={
            ...
            "conversation_scheduler_adaptive_max": "PALLAS_CONVERSATION_SCHEDULER_ADAPTIVE_MAX",
            "conversation_scheduler_adaptive_interval_sec": "PALLAS_CONVERSATION_SCHEDULER_ADAPTIVE_INTERVAL_SEC",
            ...
            "passive_repeater_concurrency": "PALLAS_INGRESS_PASSIVE_REPEATER_CONCURRENCY",
            "passive_llm_concurrency": "PALLAS_INGRESS_PASSIVE_LLM_CONCURRENCY",
            ...
            "lane_chat_adaptive_max": "PALLAS_LANE_CHAT_ADAPTIVE_MAX",
...
def _llm_section() -> WebuiEnvSection:
    ...
    return WebuiEnvSection(
        ...
        field_to_env={
            ...
            "llm_session_user_storage_window": "LLM_SESSION_USER_STORAGE_WINDOW",
            "llm_session_group_window": "LLM_SESSION_GROUP_WINDOW",
            "llm_session_group_ambient_enabled": "LLM_SESSION_GROUP_AMBIENT_ENABLED",
            "llm_session_user_ttl_sec": "LLM_SESSION_USER_TTL_SEC",
            "llm_session_private_ttl_sec": "LLM_SESSION_PRIVATE_TTL_SEC",
            "llm_session_max_content_len": "LLM_SESSION_MAX_CONTENT_LEN",
            "llm_session_strip_vision_enabled": "LLM_SESSION_STRIP_VISION_ENABLED",
            "llm_session_summary_enabled": "LLM_SESSION_SUMMARY_ENABLED",
            "llm_session_summary_threshold": "LLM_SESSION_SUMMARY_THRESHOLD",
            "llm_session_summary_keep_messages": "LLM_SESSION_SUMMARY_KEEP_MESSAGES",
            "llm_session_summary_cooldown_sec": "LLM_SESSION_SUMMARY_COOLDOWN_SEC",
            "llm_session_summary_daily_budget": "LLM_SESSION_SUMMARY_DAILY_BUDGET",
            "llm_speak_perception_enabled": "LLM_SPEAK_PERCEPTION_ENABLED",
            "llm_speak_mention_enabled": "LLM_SPEAK_MENTION_ENABLED",
            "llm_speak_ambient_enabled": "LLM_SPEAK_AMBIENT_ENABLED",
            ...
            "llm_speak_followup_max_total_sec": "LLM_SPEAK_FOLLOWUP_MAX_TOTAL_SEC",
            "llm_chat_char_budget": "LLM_CHAT_CHAR_BUDGET",
            "llm_chat_daily_calls_limit": "LLM_CHAT_DAILY_CALLS_LIMIT",
            "llm_chat_daily_tokens_limit": "LLM_CHAT_DAILY_TOKENS_LIMIT",
            "llm_tools_enabled": "LLM_TOOLS_ENABLED",
            "llm_tools_selective": "LLM_TOOLS_SELECTIVE",
            "llm_tools_soft_recall_enabled": "LLM_TOOLS_SOFT_RECALL_ENABLED",
            "llm_tools_soft_recall_min_score": "LLM_TOOLS_SOFT_RECALL_MIN_SCORE",
            "llm_tools_soft_recall_max_candidates": "LLM_TOOLS_SOFT_RECALL_MAX_CANDIDATES",
            ...
            "llm_tools_history_daily_budget": "LLM_TOOLS_HISTORY_DAILY_BUDGET",
            ...
            "llm_chat_queue_enabled": "LLM_CHAT_QUEUE_ENABLED",
            "llm_chat_queue_max": "LLM_CHAT_QUEUE_MAX",
            ...
            "llm_shut_up_silence_enabled": "LLM_SHUT_UP_SILENCE_ENABLED",
            "llm_shut_up_silence_min_sec": "LLM_SHUT_UP_SILENCE_MIN_SEC",
            "llm_shut_up_silence_max_sec": "LLM_SHUT_UP_SILENCE_MAX_SEC",
            ...
            "llm_sticker_vision_enabled": "LLM_STICKER_VISION_ENABLED",
            "llm_sticker_vision_candidate_count": "LLM_STICKER_VISION_CANDIDATE_COUNT",
            "llm_sticker_vision_timeout_sec": "LLM_STICKER_VISION_TIMEOUT_SEC",
            ...
            "llm_sticker_label_timeout_sec": "LLM_STICKER_LABEL_TIMEOUT_SEC",
            ...
            "llm_memory_auto_episode_daily_budget": "LLM_MEMORY_AUTO_EPISODE_DAILY_BUDGET",
            "llm_memory_auto_ip_enabled": "LLM_MEMORY_AUTO_IP_ENABLED",
            "llm_memory_auto_ip_daily_budget": "LLM_MEMORY_AUTO_IP_DAILY_BUDGET",
            "llm_memory_auto_ip_cooldown_sec": "LLM_MEMORY_AUTO_IP_COOLDOWN_SEC",
            "llm_memory_auto_person_facts_enabled": "LLM_MEMORY_AUTO_PERSON_FACTS_ENABLED",
            "llm_memory_auto_person_facts_cooldown_sec": "LLM_MEMORY_AUTO_PERSON_FACTS_COOLDOWN_SEC",
            "llm_memory_auto_person_facts_daily_budget": "LLM_MEMORY_AUTO_PERSON_FACTS_DAILY_BUDGET",
            "llm_memory_decay_half_life_days": "LLM_MEMORY_DECAY_HALF_LIFE_DAYS",
            "llm_memory_decay_min_importance": "LLM_MEMORY_DECAY_MIN_IMPORTANCE",
            "llm_memory_hit_boost_enabled": "LLM_MEMORY_HIT_BOOST_ENABLED",
            "llm_memory_hit_boost_sec": "LLM_MEMORY_HIT_BOOST_SEC",
